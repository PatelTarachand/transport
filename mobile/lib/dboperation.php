<?php  define("COMPANY","PAVAN PUTRA SABJI BHANDAR");
	define("COMPANY_HINDI","पवन पुत्र  सब्जी भंडार");
	define("COMPANYMOBILE","9826169751,9302069751");
	define("COMPANYADDRESS","Sabji Mandi Baloda Bazar(C.G.)");
	define("COMPANYADDRESSHINDI","सब्जी मंडी  बलोदा बाजार (छ.ग.)");
	define("SOFTWAREINSTALL","10-02-2019"); 
