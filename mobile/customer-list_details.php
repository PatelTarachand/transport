...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12">
                ...
                <?php
	$nettoral=0;	
	$sql= mysqli_query($connection,"Select * from m_supplier_party where (is_cust='1') and suppartyid <> 0 and suppartyid='$suppartyid' order by supparty_name ");
	while($row = mysqli_fetch_assoc($sql))
	{                                   
	$suppartyid = $row['suppartyid'];
	$balamt = $cmn->getopeningbalcust($connection,$row['suppartyid'],date('Y-m-d'));
	...
	while($row1=mysqli_fetch_assoc($sql)) {
			$unitid = $row1['unitid'];
			$unit_name = strtoupper($row1['unit_name']);	
			...
			$total += $balqty;
                    ...
                    <li>
                        ...
                        <div class="body white">
                            ...
                            <tr>
                            <th>Customer</th>
                            <td><?php echo $row['supparty_name'];?></td>
                            </tr>
                            <tr>
                            <th>Carret Bal</th>                                
