					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
                            	...
                            	<a class="btn btn-primary btn-lg" href="excel_cash_opening_bal.php?month=<?php echo $month; ?>&search=Search" target="_blank" style="float:right;" >  Excel </a>
							<div class="box-content nopadding">
							...
							$bilty_adv = $cmn->getvalfield($connection,"bilty_entry","sum(adv_cash)","adv_date='$searchdate'");
							$final_payment = $cmn->getvalfield($connection,"bilty_entry","sum(cashpayment)","payment_date='$searchdate'");
							...
							$commision = $cmn->getvalfield($connection,"bilty_entry","sum(commission)","cashbook_date='$searchdate'");
