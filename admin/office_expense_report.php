...
$pagename = "office_expense_report.php";
$modulename = "Office Expense Report";
...
<?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp; Office Expenses Report </legend>
                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
							<h3><i class="icon-table"></i>Office Expenses Report Details</h3>
						<a class="btn btn-primary btn-lg" href="excel_office_expense_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&head_id=<?php echo $head_id; ?>&payment_type=<?php echo $payment_type; ?>" target="_blank" style="float:right;" >  Excel </a>
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered" width="100%">
									...
									$slno=1;
									$totalexp = 0;
									$sql = "select * from other_expense $crit and compid='$compid' order by paymentdate desc";
