...
$tblpkey = "tid";
$pagename = "truckwise_tyremaping_report.php";
						...
						<div class="box">
							...
							<table class="table table-condensed table-bordered">
							  ...
							  <tr>
                                ...
                                <a href="truckwise_tyremaping_report.php" class="btn btn-inverse">Cancel</a>
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                                    ...
                                    <?php
									$slno=1;
									$sel = "select * from tyre_map where truckid='$truckid' order by mapid desc"; 
