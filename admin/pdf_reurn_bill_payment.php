...
if (isset($_GET['payid'])) {
	...
	$sql = mysqli_query($connection,"select * from return_consignor_payment where payid='$payid'");
	...
	$billid = $row['billid'];
	$billno = $cmn->getvalfield($connection,"returnbill","billno","billid='$billid'");	
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(200,4,'Payment Receive','0',1,'C',0);
...
$pdf->SetTextColor(0,0,0);
$pdf->setX(15);
$pdf->Cell(15,4,'Party Name','0',0,'R',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(120,4,'                 : '.$consigname ,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(9,4,'  Type ','0',0,'L',0);


$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,'             : '.$consi_type ,'0',1,'L',0);

$pdf->setX(8);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(25,4,' Payment Receive No.','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(118,4,'              : '.  $payment_rec_no,'0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(21,4,' Bill No ','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(65,4,': '. $billno,'0',1,'L',0);
//$pdf->Ln(2);
...
$pdf->Cell(22,4,'Receive Date ','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(113,4,'                : '.$receive_date,'0',0,'L',0);
...
$pdf->Cell(150,6,'Bill Amount',1,0,'R',0);
$pdf->Cell(40,6,number_format($bill_amount,2),1,1,'R',0);

$pdf->SetX(10);
$pdf->Cell(150,6,'Pay Amount',1,0,'R',0);
...
$pdf->Cell(40,6,number_format($bill_amount-$payamount,2),1,1,'R',0);
$pdf->Ln(3);
$pdf->SetX(15);
$pdf->Cell(14,6,'In Words :',0,0,'R',0);
$pdf->Cell(40,6,ucwords(convert_number_to_words($bill_amount-$payamount))." Rupees Only",0,1,'L',0);
$pdf->ln(10);
