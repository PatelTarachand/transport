...
if($sql)
{
   ...
   //  $compid  = $cmn->getvalfield($connection,"m_company","compid","1=1");
	...
	$consigneemobile = $cmn->getvalfield($connection,"m_consignee","phoneno","consigneeid='$consigneeid'"); 
...
//$pdf->SetX(13);
	...
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(90,4,$consignormobile,'0',1,'L',0);	
	//$this->setY(40);
	...
	$pdf->SetFont('Arial','',11);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(90,4,$consigneemobile,'0',1,'L',0);	
	//$this->setY(40);
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(0,0,0);
	...
	$pdf->SetFont('Arial','b',10);
	$pdf->SetTextColor(0,0,0);
	//$pdf->Cell(90,4," PAN No- AACCS8796G",'0',1,'L',0);
	$pdf->Ln(1);
	$pdf->SetFont('Arial','b',10);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(150,4," GST NO-".$cong_gstin,'0',1,'L',0);
	...
	//$this->SetTextColor(255,255,255);
				...
				$pdf->Cell(15,6,'LR NO',1,0,'L',1);
				$pdf->Cell(18,6,'DATE',1,0,'L',1);
				$pdf->Cell(20,6,'BILTY NO','1',0,'L',1);
	...
	$pdf->SetWidths(array(8,15,18,20,25,28,27,20,20,20,18,16,15,15,25));
	$pdf->SetAligns(array("C","L","L","L","L","L","L","R","R","R","R","R","R","R","R"));
	$pdf->SetX(5);	
	$pdf->SetFont('Arial','B',9);
...
$tot_netamt=0;
	...
	$pdf->Row(array($sn++,$lr_no,$cmn->dateformatindia($billtydate),$bilty_no,$truckno,$fromplace,$destination,$recweight,$rate,$total,$adv_consignor,number_format($ulamt,2),number_format($cgstamt,2),number_format($sgstamt,2),$net));
...
$tot_netamt += $net;         
	...
	$pdf->Cell(141,4,"",'1',0,'R',0);
	$pdf->Cell(20,4,number_format($tot_wt,2),'1',0,'R',0);
	$pdf->Cell(20,4,"",'1',0,'R',0);
	$pdf->Cell(20,4,"",'1',0,'R',0);
	$pdf->Cell(18,4,"",'1',0,'R',0);
	$pdf->Cell(16,4,"",'1',0,'R',0);
	$pdf->Cell(15,4,number_format($tot_cgstamt,2),'1',0,'R',0);
	$pdf->Cell(15,4,number_format($tot_sgstamt,2),'1',0,'R',0);
	...
	$pdf->SetFont('Arial','b',8);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(290,4,'In Words : '.ucwords(convert_number(round($tot_fr_amt)))." only",'1',1,'L',0); 
