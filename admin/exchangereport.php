          ...
          <div class="span12">
            ...
            <div class="box">
              ...
              <div class="box-title">
                ...
                <h3><i class="icon-edit"></i>Exchange Report</h3>
            ...
            <div class="box box-bordered">
              ...
              <div class="box-title">
                ...
                <h3><i class="icon-table"></i><?php echo $modulename; ?> </h3>
                 <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="excel_exchange_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" class="btn btn-primary" target="_blank">
...
//echo "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $crit and A.is_rep='Scrap'";
              $sel = "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $crit   and A.is_rep='Exchange'";
  ...
  $maxissueid = $cmn->getvalfield($connection, "issueentrydetail", "max(issueid)", "itemid='$itemid' && is_rep ='Repaired'");
	...
	?>
	<tfoot>
<tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th>Total</th><th><?php echo $totalqty; ?></th></tr>
                ...
                <table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                  ...
                  <tbody>
                    ...
                    $slno = 1;
                      ...
                      //echo "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $cond   and A.is_rep='Repaired'";
                      $sel = "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $cond  and A.is_rep='Exchange'";
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="print_exchange_entry.php?issueid=<?php echo ucfirst($row['issueid']); ?>" target="_blank" class="btn btn-warning">Print</a>
                        </td>
                        <td class='hidden-480'>
