...
//echo $sel1 = "SELECT * FROM `consignee_payment` WHERE sessionid='$sessionid' and compid='$compid' $cond1 order by payid desc";
...
$html .="<hr>";
 ...
 ";
  ...
  $html .="
		  ...
		  $sql_table = "SELECT * FROM `bill` WHERE sessionid='$sessionid' and compid='$compid' and consi_type='Consignee' $cond";
		}
...
<table border='1' width='100%'>
								...
								<thead>
								<tr>
									<th colspan='10' align='center'><strong> Consignee Payments</strong></th>
								</tr>
									<tr>
										<th>S No</th>
									   <th>Bill No</th>
 ...
 $sel1 = "SELECT * FROM `consignee_payment` WHERE sessionid='$sessionid' and compid='$compid' $cond1 order by payid desc";
							$res1 = mysqli_query($connection,$sel1);
									...
									$payment_rec_no =  $cmn->getvalfield($connection,"consignee_payment","payment_rec_no","payid ='$row1[payid]'");	
									$receive_date =  $cmn->getvalfield($connection,"consignee_payment","receive_date","payid ='$row1[payid]'");
									$narration =  $cmn->getvalfield($connection,"consignee_payment","narration","payid ='$row1[payid]'");
									$tdsamt =  $cmn->getvalfield($connection,"consignee_payment","tdsamt","payid ='$row1[payid]'");
									$deduct_amount =  $cmn->getvalfield($connection,"consignee_payment","deduct_amount","payid ='$row1[payid]'");
									$payamount =  $cmn->getvalfield($connection,"consignee_payment","payamount","payid ='$row1[payid]'");	
