...
if(isset($_POST['sub']))
{
 ...
 $sql_update = "update bidding_entry set newrate='$newrate',payment_date='$payment_date',commission= 
	'$commission',chequepaydate='$chequepaydate',tds_amt='$tds_amt',cashpayment ='$cashpayment',trip_commission='$trip_commission',	chequepayment='$chequepayment',chequepaymentno='$chequepaymentno',payeename='$payeename',deduct='$deduct',
	deduct_r='$deduct_r',
    	...
    	<legend class="legend_blue"><i class="icon-edit"></i>&nbsp; Bilty Payment Emami</legend>   
               ...
               <div class="innerdiv">
			    ...
			    <div class="innerdiv">
                    <div> Commission  </div>
                    <div class="text">
                     <input type="text" class="formcent" value="<?php echo $trip_commission; ?>" name="trip_commission" id="othrcharrate" style="border: 1px solid #368ee0;" onChange="gettot_paid();"  autocomplete="off" >
              ...
              <div class="innerdiv">
                ...
                <div class="innerdiv">
                    ...
                    <br>
					<br>
                    <input type="submit" name="sub" class="btn btn-success" id="" value="Request"  onClick="return chepayment(); " >
                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
								<h3><i class="icon-table"></i><?php echo $modulename; ?> Details  <span class="red">( Only 500 records are shown below for more <a href="bilty_paymenrecord_emami.php" target="_blank">Click Here</a>)</span></h3>
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$sel = "select  * from bidding_entry where is_complete=1 && consignorid=4 $crit order by payment_date desc limit 50";
                        ...
                        <tr>
                           ...
                           <td><?php echo $row['commission'];?></td>                         
                            ...
                            <td><a href="pdf_paymentreceipt.php?bilty_id=<?php echo $row['bid_id'];?>" target="_blank" class="btn btn-success">Print Recipt</a>
                    </td>
                            <td class='hidden-480'>
