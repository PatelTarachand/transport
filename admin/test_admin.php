		...
		<img src="menu/home.png" style="width:30px;"/><span style="color:#FF0000; font-weight:bold"> GO TO HOME </span></a></legend>
                ...
                <div class="row-fluid">
					<div class="span12">
								...
								<table class="table table-hover table-nomargin ">
									<thead>
										<tr>
											...
											<th >Total Amount</th>
											<?php if($_SESSION['username']!='admin' or $_SESSION['username']!='skdiwan'){ ?>  
											<th >Status</th>
											<?php } ?>
										</tr>
									</thead>
						...
						$query="select * from bidding_entry where 1=1  $cond and is_complete='1' and payment_status='0'";
                        }elseif($_SESSION['username']=='admin'){
                        
                        $query="select * from bidding_entry where 1=1  $cond and is_complete='1' and payment_status='1'";
                        }
					...
					<tr>
                            ...
                            <td>
								<?php if($row['payment_status']==1){ echo "Verified"; } elseif($row['payment_status']==2){
								echo "Hold By Diwan sir"; } elseif($row['payment_status']==3){ echo "Released by Admind"; } elseif($row['payment_status']==4){ echo "Hold by Admin"; } ?>
                            </td>
