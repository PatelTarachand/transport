...
$tblpkey = 'bid_id';
$pagename  ='bilty_dispatch_emami.php';
    	...
    	<legend class="legend_blue"><i class="icon-edit"></i>&nbsp; <span style="color:#F00"></span><?php echo $modulename; ?> </legend>
               ...
               <div class="innerdiv" style="display: flex;align-items: center;">
                    ...
                    <select id="bid_id" name="bid_id" class="formcent select2-me" style="width:220px;" onChange="getdetail();">
						...
						$sql_fdest = mysqli_query($connection,"select bid_id,bilty_no from bidding_entry where compid='$compid' and is_bilty=1 && sessionid='$sessionid'");
...
//}
						...
						<div class="box-title">
							...
							<div class="box-content nopadding" style="overflow:scroll;">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                                    ...
                                    <?php
									$slno=1;
									 $sel = "select * from bidding_entry where isdispatch=1 && sessionid='$sessionid'  and compid='$compid' order by bid_id desc limit 500";
	...
	$itemname = $cmn->getvalfield($connection,"inv_m_item","itemname","itemid='$itemid'");
									...
									?>
										<tr tabindex="<?php echo $slno; ?>" class="abc">
                                           ...
                                           <a href="pdf_paiddispatchreceipt.php?bid_id=<?php echo $row['bid_id'];?>" target="_blank" class="btn btn-sm btn-success">Print Recipt</a> 
  ...
  <a href= "bilty_dispatch_emami.php?bid_id=<?php echo ucfirst($row['bid_id']); ?>&edit=true"  style="display: none;"id="add_data_list_edit_<?php echo  $row['bid_id'] ; ?>">
                                           &nbsp;&nbsp;&nbsp;
...
// alert(data);
            if(data==1) 
            {
                location.href="bilty_dispatch_emami.php?bid_id="+otp_bid_id;
