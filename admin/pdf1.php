...
$pdf->SetFont('Arial','B',8);
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(27,8,'Cash+Di Adv(Self)',1,0,'R');
                                                     
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(16,8,'Cash Adv',1,0,'R');
                                                     
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(18,8,'Other Adv',1,0,'R');
                                            ...
                                            $pdf->SetFont('Arial','',8);
                                                   ...
                                                   //  $pdf->Cell(30,8,$toplace,1,0,'L');
                                                    ...
                                                    //  $pdf->Cell(13,8,$trip_commission,1,0,'R');
                                                     ...
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(15,8,$sortagr,1,0,'R');
                                                     
                                                     
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(10,8,$sortagr,1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','',8);
                                                     ...
                                                     $pdf->Cell(27,8,round($adv_cash),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(16,8,round($adv_consignor),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(18,8,round($adv_other),1,0,'R');
                                                ...
                                                $total_tds+=$tds_amt;
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,12,$total_deduct,1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(27,12,$total_adv,1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(16,12,round($toal_advconsi),1,0,'R');
                                                   
$pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(18,12,'',1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                   //  $pdf->Cell(24,12,'',1,0,'R');
                                                     ...
                                                     $pdf->Cell(20,12,number_format(round($great_total),2),1,0,'R');
                                                      ...
                                                      $pdf->SetFont('Arial','B',10);
                                                     $pdf->Cell(227,12,'Grant Total Amount',1,0,'C');

                                                     
                                                     $pdf->Cell(54,12,number_format(round($great_total),2),1,0,'R');
