...
$c_logo = $cmn->getvalfield($connection,"m_company","c_logo","compid='$_SESSION[compid]'");
 ...
 $payment_date = dateformatindia($cmn->getvalfield($connection,"bidding_entry","payment_date","voucher_id='$bulk_voucher_id'"));
...
class PDF extends PDF_Rotate
{
  ...
  var $aligns;
	function Header()
	{
		...
		$this->RotatedText(110,150,$payment_date,45);
		}
 ...
 $paidto=$incrow['paidto']; 
                        $pdf->Cell(125,10,'Truck Owner: '.$OWNrow['ownername'] ,2,0,'L');
                                       ...
                                       $pdf->Cell(45,10,'',2,0,'L');
                                        ...
                                        $pdf->SetFont('Arial','',10);
                                        $pdf->Cell(95,8,'Location: Raipur',2,0,'L');
                                        $pdf->Ln(6);
                                          $pdf->SetFont('Arial','',10);
                                                ...
                                                $total_tds+=$tds_amt;
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->Cell(20,12,number_format(round($great_total),2),1,0,'R');
                                                      ...
                                                      $pdf->SetFont('Arial','B',10);
                                                     $pdf->Cell(218,12,'Grant Total Amount',1,0,'C');

                                                     
                                                     $pdf->Cell(61,12,number_format(round($great_total),2),1,0,'R');
