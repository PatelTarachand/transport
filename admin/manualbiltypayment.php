...
$tblname = 'manualbiltypayment';
$tblpkey = 'mbiltypayid';
$pagename  ='manualbiltypayment.php';
$modulename = "Manual Bilty Payment";

if(isset($_GET['mbiltypayid']))
{
	$mbiltypayid = trim(addslashes($_GET['mbiltypayid']));
}
else
$mbiltypayid='0';

$sql = mysqli_query($connection,"select * from manualbiltypayment where mbiltypayid='$mbiltypayid'");
...
if(isset($_POST['sub']))
{
	$mbiltypayid = trim(addslashes($_POST['mbiltypayid']));
	$remark = trim(addslashes($_POST['remark']));
	$paydate = $cmn->dateformatusa(trim(addslashes($_POST['paydate'])));
	...
	if($mbiltypayid==0) {
			mysqli_query($connection,"insert into manualbiltypayment set remark='$remark',paydate='$paydate',	
			qty='$qty',amount='$amount',ownerid='$ownerid',truckid='$truckid',createdate='$createdate',
			ipaddress='$ipaddress',
			sessionid='$sessionid'");
			}
			else{
			mysqli_query($connection,"update manualbiltypayment set remark='$remark',paydate='$paydate',
			ownerid='$ownerid',truckid='$truckid',qty='$qty',amount='$amount',createdate='$createdate',
			ipaddress='$ipaddress',sessionid='$sessionid' where mbiltypayid='$mbiltypayid'");
			}
...
<body data-layout-topbar="fixed">
 <?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
		<div id="main">
			  <div class="container-fluid">
                   ...
                   <form method="post" action="" onSubmit="return checkinputmaster('remark,paydate')">
  ...
  <select id="ownerid" name="ownerid" class="select2-me input-large" style="width:220px;" >
                        ...
                        <?php 
                        $sql_fdest = mysqli_query($connection,"select ownerid,ownername,father_name from m_truckowner order by ownername");
                        while($row_fdest = mysqli_fetch_array($sql_fdest))
                        {
                        ?>
                            <option value="<?php echo $row_fdest['ownerid']; ?>"><?php echo $row_fdest['ownername'].'/'.$row_fdest['father_name']; ?></option>
                        <?php
                        } ?>
                        </select>
...
<div class="innerdiv">
  ...
  <select id="truckid" name="truckid" class="select2-me input-large" style="width:220px;" >
                ...
                <div class="innerdiv">
                    <div>Amount<span class="err" style="color:#F00;">*</span></div>
                    <div class="text">
                ...
                <div class="innerdiv">
                    <div> Payment Date <span class="err" style="color:#F00;">*</span></div>
                    <div class="text">
                     <input type="text" id="paydate" name="paydate" class="formcent" value="<?php echo $cmn->dateformatindia($paydate); ?>"  autocomplete="off"  >
                </div>
                </div>
                ...
                <div class="innerdiv">
                    <div> Narration</div>
                    <div class="text">                    		
<input type="text" class="formcent" id="remark" name="remark" value="<?php echo $remark; ?>"  autocomplete="off"  >                                                     
                </div>
               </div>
				...
				<center>	
    		        ...
    		        <input type="hidden" name="mbiltypayid" id="mbiltypayid" data-key="primary" value="<?php echo $mbiltypayid; ?>">
                    </form>
                   			 </div>
                    		</div>
                	</div>  <!--rowends here -->
                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							...
							<a class="btn btn-primary btn-lg" href="excel_manualbiltypayment.php" target="_blank" style="float:right;" >  Excel </a>
                        ...
                        <tr>
                            ...
                            <td class='hidden-480'>
                           <a href= "?mbiltypayid=<?php echo ucfirst($row['mbiltypayid']);?>"><img src="../img/b_edit.png" title="Edit"></a>
						    &nbsp;&nbsp;&nbsp;
                                           <a onClick="funDel('<?php echo $row['mbiltypayid']; ?>')" ><img src="../img/del.png" title="Delete"></a>
