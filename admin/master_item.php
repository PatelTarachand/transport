						...
						<div class="box">
							...
							<div class="box-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                            	<select tabindex="3" name="groupid" id="groupid" class="formcent select2-me" style="width: 220px;">
                               ...
                               <script>document.getElementById('groupid').value=<?php echo $groupid; ?></script>
                                 ...
                                 <tr>
                                  ...
                                  <td>
                                        <select tabindex="5" name="unitmessure" id="unitmessure" class="formcent select2-me" style="width: 220px;">
                                            <option value="">-Select-</option>
                                            <option value=""> - Select - </option>
