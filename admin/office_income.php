...
$pagename = "office_income.php";
$modulename = "Office Income";
...
else
{
	$otherincomeid=0;	
		...
		if(isset($_POST['submit']))
		{
			...
			if($stype !='' && $head_id !='' && $incomeamount !='' && $paymentdate !='')
			{
			if($tblpkey_value==0)
			{	
			
				mysqli_query($connection,"insert into otherincome set stype='$stype',payeename='$payeename',head_id='$head_id',incomeamount='$incomeamount',payment_type='$payment_type',chequeno='$chequeno',bankid='$bankid',chequedate='$chequedate',paymentdate='$paymentdate',narration='$narration',createdby='$userid',createdate='$createdate',compid='$compid',ipaddress='$ipaddress',sessionid='$sessionid'");
				$action = 1;
			}
			else
			{
				mysqli_query($connection,"update otherincome set stype='$stype',payeename='$payeename',head_id='$head_id',incomeamount='$incomeamount',payment_type='$payment_type',chequeno='$chequeno',bankid='$bankid',chequedate='$chequedate',paymentdate='$paymentdate',narration='$narration',createdate='$createdate',ipaddress='$ipaddress',compid='$compid'  where otherincomeid='$tblpkey_value'");
				$action = 2;
			}			
...
<body>
	...
	<div class="container-fluid" id="content">
		...
		<img src="menu/home.png" style="width:30px;"/><span style="color:#FF0000; font-weight:bold"> GO TO HOME </span></a></legend> -->
                            ...
                            <select id="stype" name="stype" class="formcent select2-me" style="width:224px;" onChange="getoption();" >
                                ...
                                <script>document.getElementById('stype').value = '<?php echo $stype; ?>';</script>
                                 ...
                                 <tr>
                                    ...
                                    <td width="60%">
                            <input list="browsers" value="<?php echo $payeename; ?>" id="payeename" name="payeename" autocomplete="off" class="input-large" >
                            ...
                            <select id="head_id" name="head_id" class="formcent select2-me" style="width:224px;" onChange="hidedate(this.value);" >
                                ...
                                <script>document.getElementById('head_id').value = '<?php echo $head_id; ?>';</script>
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                  <td><strong>Income Date:</strong></td>
                    ...
                    <input type="submit" name="submit" id="submit" value="Save" class="btn btn-success" onClick="return checkinputmaster('truckid,head_id,incomeamount');" >
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$slno=1;
									$sel = "select * from otherincome where  $cond && truckid='0' and compid='$compid' order by paymentdate desc";
									...
									?>
										<tr>
                                           ...
                                           &nbsp;&nbsp;&nbsp;
                                          <!-- <a onClick="funDel('<?php //echo $row['otherincomeid']; ?>')" ><img src="../img/del.png" title="Delete"></a>-->
                                           </td>
										</tr>
                                        <?php
