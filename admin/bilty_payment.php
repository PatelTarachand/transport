<?php
 error_reporting(0); include("dbconnect.php");
$tblname = 'bilty_entry';
$tblpkey = 'bilty_id';
...
if(isset($_POST['sub']))
{
 ...
 $sql_update = "update bidding_entry set newrate='$newrate',payment_date='$payment_date',commission= 
	'$commission',chequepaydate='$chequepaydate',tds_amt='$tds_amt',cashpayment ='$cashpayment',	chequepayment='$chequepayment',chequepaymentno='$chequepaymentno',payeename='$payeename',deduct='$deduct',
	deduct_r='$deduct_r',ac_holder='$ac_holder',
	...
	ipaddress = '$ipaddress' where bid_id='$bid_id'"; 
			...
			echo "<script>location='bilty_payment.php?action=2'</script>";
	}
}
...
<body data-layout-topbar="fixed">
 <?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"><i class="icon-edit"></i>&nbsp; Bilty Payment</legend>   
                <div class="innerdiv">
               ...
               <div class="innerdiv">
                ...
                <div class="innerdiv">
                    ...
                    <div class="text">
                     <input type="text" class="formcent"  value="<?php echo $rate_mt; ?>" id="rate_mt" required readonly style="border: 1px solid #368ee0;background-color:#cacecb;"  autocomplete="off"  >
                </div>
                </div>
			    ...
			    <div class="innerdiv">
                    <div> Commission  </div>
                    <div class="text">
                     <input type="text" class="formcent" value="<?php echo $othrcharrate; ?>" id="othrcharrate" style="border: 1px solid #368ee0;" onChange="gettot_paid();"  autocomplete="off" >
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$sel = "select  * from bidding_entry where is_complete=1 $crit order by payment_date desc limit 50";
...
function gettot_paid()
{
	...
	var remainingpayment = balamount - tot_paid;
