...
$tblname = 'tokenpass';
$tblpkey = 'tpass_id';
$pagename  ='token_entry_report.php';
$modulename = "Token Pass Entry Report";
...
if($fromdate !='' && $todate !='')
{
		$crit.=" and tocken_date between '$fromdate' and '$todate' ";	
}
...
<?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp;Token Pass Report </legend>
                            <table width="1037">
                                    <tr>
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
                            	...
                            	<a class="btn btn-primary btn-lg" href="excel_token.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&ownerid=<?php echo $ownerid; ?>&itemid=<?php echo $itemid; ?>&consignorid=<?php echo $consignorid; ?>" target="_blank" 
