...
// $logo = 'bps.png';
  ...
  $compid = $cmn->getvalfield($connection,"bidding_entry","compid","bid_id='$bid_id'");
 $userid = $cmn->getvalfield($connection,"bidding_entry","userid","bid_id='$bid_id'");
...
$companygst = $cmn->getvalfield($connection,"m_company","gst_no","compid='$compid'");
...
$company_gst = $cmn->getvalfield($connection,"m_company","gst_no","compid='$compid'");
$c_logo = $cmn->getvalfield($connection,"m_company","c_logo","compid='$compid'");

$companyaddrs = $cmn->getvalfield($connection,"m_company","headaddress","compid='$compid'");
$companymob1 = $cmn->getvalfield($connection,"m_company","mobileno1","compid='$compid'");
$companymob2 = $cmn->getvalfield($connection,"m_company","mobileno2","compid='$compid'");
...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
   ...
   $this->SetFont('arial','b',16);
   $this->Image('logo/'.$c_logo,6,10,27,13);//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
...
$pdf->AddPage('L','A5');
	...
	$pdf->SetX(10);
		$pdf->SetFont('arial','',8);
	$pdf->MultiCell(60,4,"$consignorname \n$consignoraddress\n $consignorcontactno",0,'L');
	...
	$pdf->MultiCell(80,0,"$consignorcong_gstin ",0,'L');
...
// 	    $pdf->MultiCell(60,4,"$destination",0,'L');
 ...
 //   $pdf->Cell(66,5,"Excise Invoice No : $invoiceno",1,1,'L',0);
	...
	$pdf->Cell(18,6,'Item',1,0,'L',0);
		$pdf->Cell(28,6,'Meth. of Packing',1,0,'L',0);
	$pdf->Cell(22,6,'Weight(bags)','1',0,'C',0); 
	$pdf->Cell(19,6,'Weight(MT)',1,0,'L',0);
	$pdf->Cell(20,6,'OWN Rate',1,0,'C',0);
	$pdf->Cell(25,6,'Freight Amt',1,1,'C',0);
	$pdf->SetFont('Arial','',6);
	
	$pdf->SetX(5);
	$pdf->SetFont('arial','b',6);	
	$pdf->Cell(18,8,$itemname,1,0,'L',0);
	$pdf->Cell(28,8,$m_packing."  $packingqty",1,0,'L',0);
	$pdf->Cell(22,8,$noofqty,1,0,'C',0);
	$pdf->Cell(19,8,$totalweight.' MT',1,0,'C',0);
	$pdf->Cell(20,8,$own_rate." / MT",1,0,'R',0);
	$pdf->Cell(25,8,$total_freight,1,1,'R',0);
