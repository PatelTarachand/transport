...
if(isset($_POST['sub']))
{
 ...
 $sql_update = "update bidding_entry set newrate='$newrate',pay_no='$pay_no',payment_date='$payment_date',commission= 
	...
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"><i class="icon-edit"></i>&nbsp; Bilty Payment Emami</legend>   
               ...
               <div class="innerdiv">
                    <div> Pay No. </div>
                    <div class="text">
                     <input type="text" class="formcent"  name="pay_no" id="pay_no" readonly value="<?php echo $pay_no; ?>" required style="border: 1px solid #368ee0;background-color:#cacecb;"  autocomplete="off"  >
                </div>
                </div>
                <div class="innerdiv">
					...
					<div class="span12">
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$sel = "select  * from bidding_entry where is_complete=1 $crit && consignorid=4 order by bid_id desc limit 50";
                        ...
                        <tr>
                           ...
                           <td><?php echo $row['commission'];?></td>                         
                            ...
                            <td class='hidden-480'>
                           <a href= "?bid_id=<?php echo $row['bid_id'];?>"><img src="../img/b_edit.png" title="Edit"></a>
                           </td>
                        </tr>
                                        <?php
										$slno++;
...
function gettot_paid()
{
	...
	document.getElementById('netamount').value= netamt;
		tds_amt = Math.round(netamt*tds_amt/100);
