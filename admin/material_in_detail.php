          ...
          <div class="span12">
            ...
            <div class="box">
              ...
              <div class="box-title">
                ...
                <h3><i class="icon-edit"></i>Repaired Report</h3>
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <div class="box box-bordered">
              ...
              <!--<p align="right" style="margin-top:7px; margin-right:10px;"> <a href="excel_material_in_detail.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" class="btn btn-info" target="_blank">-->
              <!--    <span style="font-weight:bold;text-shadow: 2px 2px 2px #000; color:#FFF">Print Excel</span>-->
              <!--    </a></p>-->
...
// echo  "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $crit   and A.is_rep='Repaired' && A.is_used='0' " ;
              $sel = "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $crit   and A.is_rep='Repaired' && A.is_used='0'  group b";
  ...
  $maxissueid = $cmn->getvalfield($connection, "issueentrydetail", "max(issueid)", "itemid='$itemid' && is_rep ='Repaired'");
    ...
    <td><?php echo $row['unitname']; ?></td>
                        ...
                        <td><?php echo $cmn->dateformatindia($row['issudate']); ?></td>
                        	<td><?php echo  $cmn->dateformatindia($maxissudate);?></td>	
	...
	?>
	<tfoot>
<tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th> Total</th><th><?php echo $totalqty1; ?></th></tr>
...
<?php } else {?>
                ...
                <table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                  ...
                  <tbody>
                    ...
                    //   echo "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $cond   and A.is_rep='Repaired' A.is_used='0'";
                      $sel = "select * from issueentrydetail as A left join issueentry as B on A.issueid = B.issueid  $cond  and A.is_rep='Repaired' && A.is_used='0' group by issuno";
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                        <a href="print_repair_entry.php?issueid=<?php echo ucfirst($row['issueid']); ?>" target="_blank" class="btn btn-warning">Print</a>
                        </td>
                        <td class='hidden-480'>
