...
$tblpkey = "tid";
$pagename = "tyrenowise_tyremaping_report.php";
$modulename = "Tyre No Wise Tyre Mapping Report";
						...
						<div class="box">
							...
							<table class="table table-condensed table-bordered">
							  ...
							  <tr>	
                                ...
                                <td><input type="submit" name="search" id="search" class="btn-info" value="Search"> &nbsp;&nbsp;
                                <a href="tyrenowise_tyremaping_report.php" class="btn btn-inverse">Cancel</a>
                                </td>
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									<thead>
										<tr>
                                        <th width="5%">Sno</th> 
                                        <th width="20%">Tyre No</th>
                                        <th width="21%">Truck No</th>
                                        <th width="18%">Location</th>
                                        <th width="17%">Uploading Date</th>
                                         <th width="19%">Download Date</th>                                                     
                                       </tr>
									</thead>
                                    <tbody>
                                    <?php
									 ...
									 $tid =  $cmn->getvalfield($connection,"tyre_purchase","tid","tnumber='$tnumber'");
									$slno=1;
								   $sel = "select * from tyre_map where tid='$tid' order by mapid desc"; 
									...
									?>
										...
										<tr>
                                                ...
                                                <td width="17%"><?php echo $cmn->dateformatindia($row['uploaddate']);?></td>
                                                 <td width="19%"><?php echo $cmn->dateformatindia($row['downdate']);?></td>
								    	</tr>
                                        <?php
										$slno++;
									}
