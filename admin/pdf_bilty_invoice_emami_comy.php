...
$company_gst = $cmn->getvalfield($connection,"m_company","gst_no","1=1");

$companyaddrs = $cmn->getvalfield($connection,"m_company","headaddress","1=1");
$companymob1 = $cmn->getvalfield($connection,"m_company","mobileno1","1=1");
$companymob2 = $cmn->getvalfield($connection,"m_company","mobileno2","1=1");
$phoneno = $cmn->getvalfield($connection,"m_company","phoneno","1=1");
$companyname = $cmn->getvalfield($connection,"m_company","cname","1=1");
...
if($bid_id !='')
{
    ...
    $total_freight=$totalweight*$comp_rate;
...
//$this->Image('bpslogo.png',80,3,35,16);//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
		...
		$this->SetX(8);
		$this->SetFont('arial','b',16);		
		$this->Image('images/ltc.jpg',10,10,20);
		$this->Ln(5);
    ...
    //$pdf->Cell(190,0,"$companyaddrs Office No : $companymob1, $companymob1",0,1,'L');
        ...
        $this->SetX(138);
        $this->SetFont('arial','b',11);
        $this->Cell(68,0,"GR No.: $lr_no",0,1,'C',0);
		...
		$this->Cell(10,0,"Office No.:",0,1,'L');
		...
		$this->SetX(97);
		$this->SetFont('arial','',9);		
		$this->Cell(10,0,"Plant No.: ",0,1,'L');
		
		$this->SetY(35);
		$this->SetX(97);
		$this->SetFont('arial','',9);		
		$this->Cell(190,0,$companymob1.",7205370698",0,1,'L');
...
$pdf->AddPage('L','A5');
 ...
 //   $pdf->Cell(66,5,"Excise Invoice No : $invoiceno",1,1,'L',0);
	...
	$pdf->SetFont('arial','',11);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(68,5,"DI No            : $di_no ",1,0,'L',0);
	
    $pdf->SetY(49);
    $pdf->SetX(137);
    $pdf->SetFont('arial','',11);
    $pdf->SetTextColor(0,0,0);
    $pdf->Cell(68,5,"DI Date         : $bilty_date",1,0,'L',0);

    $pdf->SetY(54);
    $pdf->SetX(137);
    $pdf->SetFont('arial','',11);
    $pdf->SetTextColor(0,0,0);
    $pdf->Cell(68,5,"Ex.Inv.No      : $invoiceno",1,0,'L',0);
    ...
    $pdf->SetFont('arial','',11);
    $pdf->SetTextColor(0,0,0);
    $pdf->Cell(68,5,"Vehicle Type : ",1,0,'L',0);
	...
	$pdf->Cell(30,6,'Material',1,0,'L',0);
	$pdf->Cell(24,6,'Contents(bags)','1',0,'C',0); 
	$pdf->Cell(20,6,'Weight(MT)',1,0,'L',0);
	$pdf->Cell(18,6,'Bid Rate',1,0,'C',0);
	$pdf->Cell(15,6,'Rate',1,0,'C',0);
	...
	$pdf->Cell(18,8,$comp_rate." / MT",1,0,'R',0);
	$pdf->Cell(15,8,'',1,0,'R',0);
	...
	$pdf->SetX(137);
	$pdf->SetFont('arial','',11);
	$pdf->Cell(68,6,"Owner Name & Details ",1,1,'L');	
    ...
    $pdf->Cell(107,8,"Add: GST Payable 5% of Gross Freight value by Consignee/Consignor under RCM   ",1,0,'L',0);
