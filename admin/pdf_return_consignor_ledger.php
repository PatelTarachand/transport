...
$pagename = 'pdf_return_consignor_ledger.php';
...
$html .="<hr>";
 ...
 ";
  $html .= "<div 	 if($consignorid != 'all'){	style='width:100%; float:left; margin-left: 10px;%'}else { style='float:left; width:49.5%' }>";
 ...
 <div width='34%'><strong>Opening Balance: <i class='fa fa-inr'></i>$bal_amt1</strong>
							 </div>
	";
$slno++;
...
<table border='1' cellspacing='0' width='100%'>
								...
								$slno=1;
								if($consignorid == 'all'){
									$sel1 = "SELECT * FROM `return_consignor_payment` WHERE sessionid='$sessionid' and compid='$compid'order by payid desc";
...
$mpdf->WriteHTML($html);
$mpdf->SetTitle('pdf_return_consignor_ledger');
