...
$module = "Masters";
$keyvalue="";
$compid = $cmn->getvalfield($connection,"bilty_payment_voucher","compid","bid_id='$payid'");
$userid = $cmn->getvalfield($connection,"bilty_payment_voucher","userid","bid_id='$payid'");

	$payid = trim(addslashes($_GET['payid']));
	$sql = mysqli_query($connection,"select * from bilty_payment_voucher where payid='$payid'");
