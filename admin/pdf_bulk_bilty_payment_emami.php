...
$c_logo = $cmn->getvalfield($connection,"m_company","c_logo","compid='$_SESSION[compid]'");
    ...
    $res_table = mysqli_query($connection,$sql_table);
                  ...
                  $OWNres = mysqli_query($connection,$OWN);
                   ...
                   $invoicquery = "SELECT * from m_truck as A left join bidding_entry as B on (A.truckid = B.truckid)   $cond and B.is_complete=1 && B.compid=$compid && B.recweight !='0' ";
                                          ...
                                          $pdf->SetFont('Arial','B',8);
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->Cell(20,8,'Total Net Amt',1,0,'R');
                                                      ...
                                                      $pdf->Ln();
                                                         $sn=1;
                                 $sel = "SELECT * from m_truck as A left join bidding_entry as B on (A.truckid = B.truckid)   $cond and B.is_complete=1 && B.compid=$compid  ";
