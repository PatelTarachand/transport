...
$truckuchantiid = trim(addslashes($_GET['truckuchantiid']));
	...
	$paymentdate =  $cmn->dateformatindia($row['paymentdate']);
		$chequedate =  $cmn->dateformatindia($row['chequedate']);
	$head_id = $row['head_id'];
	...
	$narration = $row['narration'];
		...
		$bankname = $cmn->getvalfield($connection,"m_bank","bankname","bankid='$row[bankid]'");
...
$this->Cell(22,6,'Pay Type : ' ,0,0,'L',0);
$this->Cell(20,6,ucfirst($payment_type),0,0,'L',0);
	}
	function Footer()
	{ 
	    $this->SetY(-15);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(18,4,'Truck No.','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,': '.$truckno,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(60,4,': '.$drivername,'0',0,'L',0);
...
$pdf->SetX(10);
$pdf->Cell(150,18,'Uchanti Amount ',1,0,'L',0);
$pdf->Cell(40,18,number_format($uchantiamount,2),1,1,'R',0);

$pdf->SetX(10);
$pdf->Cell(150,6,'Net Amount ',1,0,'R',0);
$pdf->Cell(40,6,number_format($uchantiamount,2),1,1,'R',0);
$pdf->Ln(2);
$pdf->SetY(51);
$pdf->SetX(50);
$pdf->Cell(30,6,'Cheque No.' ,1,0,'L',0);
$pdf->Cell(20,6,$chequeno,1,0,'L',0);

$pdf->Cell(10,6,'A/C' ,1,0,'L',0);
$pdf->Cell(50,6,$ac_number,1,0,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(20,15,'Narration :' ,0,0,'L',0);
$pdf->SetFont('Arial','',10);
$pdf->Cell(50,15,$narration,0,0,'L',0);
