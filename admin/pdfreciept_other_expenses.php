...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(170,4,'Expanse Receipt','0',1,'C',0);

$pdf->Ln(10);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(25,4,'Expance Type','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(20,4,': '.$stype,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetX(10);
$pdf->Cell(150,18,'Expance Amount ',1,0,'L',0);
$pdf->Cell(40,18,number_format($expamount,2),1,1,'R',0);

$pdf->SetX(10);
$pdf->Cell(150,6,'Net Amount ',1,0,'R',0);
$pdf->Cell(40,6,number_format($expamount,2),1,1,'R',0);
$pdf->Ln(2);
$pdf->SetY(53);
$pdf->SetX(50);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(22,20,'Narration :' ,0,0,'L',0);
$pdf->SetFont('Arial','',10);
$pdf->Cell(10,20,$narration,0,0,'L',0);
