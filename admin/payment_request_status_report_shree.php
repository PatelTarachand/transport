...
$tblpkey = 'bid_id';
$pagename  ='payment_request_status_report_shree.php';
	...
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp;<?php echo $modulename; ?> Report </legend>
                       ...
                       <option value="2">Reject</option>
                        ...
                        <script>document.getElementById('status').value = '<?php echo $status; ?>';</script></td> <td>
                        	<input autocomplete="off" type="text" class="input-large" name="ac_holder" value="<?php echo $ac_holder; ?>" >
                        </td>                 
