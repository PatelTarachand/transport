...
{	
	...
	if($compid==0)
	{
		...
		if($cnt == 0)
		{
			...
			// mobileno1='$mobileno1', ownername='$ownername', email_id='$email_id',pan_card='$pan_card',gst_no='$gst_no',stateid='$stateid',venderCode='$venderCode',
			//  mobileno2='$mobileno2',saaccode='$saaccode',gstvalid='$gstvalid', account_no='$account_no',bank_name='$bank_name',branch='$branch',ifsc_code='$ifsc_code',caddress='$caddress',chl_prefix='$chl_prefix',createdate=now(),sessionid = '$_SESSION[sessionid]'";die;
			  $sql_insert="insert into m_company set cname = '$cname', headname = '$headname',headaddress = '$headaddress', phoneno = '$phoneno',
			 mobileno1='$mobileno1', ownername='$ownername', email_id='$email_id',pan_card='$pan_card',gst_no='$gst_no',stateid='$stateid',venderCode='$venderCode',
			  mobileno2='$mobileno2',saaccode='$saaccode',gstvalid='$gstvalid', account_no='$account_no',bank_name='$bank_name',branch='$branch',ifsc_code='$ifsc_code',account_holder='$account_holder',caddress='$caddress',chl_prefix='$chl_prefix',createdate=now(),sessionid = '$_SESSION[sessionid]'";
			 // echo  $sql_insert;
	...
	// 	mobileno1='$mobileno1', ownername='$ownername', email_id='$email_id',pan_card='$pan_card',c_logo='$doc_name',gst_no='$gst_no',stateid ='$stateid',venderCode='$venderCode',
	//    mobileno2='$mobileno2',gstvalid='$gstvalid', caddress='$caddress',chl_prefix='$chl_prefix' ,lastupdated=now() where compid='$compid'";die;
		...
		$sql_update = "update  m_company set cname = '$cname', headname ='$headname',headaddress = '$headaddress', phoneno = '$phoneno',saaccode='$saaccode',
			   mobileno1='$mobileno1', ownername='$ownername', email_id='$email_id',pan_card='$pan_card',gst_no='$gst_no',stateid ='$stateid',venderCode='$venderCode',
			  mobileno2='$mobileno2',gstvalid='$gstvalid', account_no='$account_no',bank_name='$bank_name',branch='$branch',ifsc_code='$ifsc_code',account_holder='$account_holder', caddress='$caddress',chl_prefix='$chl_prefix' ,lastupdated=now() where compid='$compid'";
		mysqli_query($connection,$sql_update);
		if($_FILES['c_logo']['tmp_name']!="")
				{
					$doc_name = $c_logo['name'];
		$ext = pathinfo($doc_name, PATHINFO_EXTENSION);	
		$imgname=$keyvalue.".".$ext;
                 ...
                 <input type="text" name="ownername" value="<?php echo $ownername; ?>" id="ownername" class="input-large" >
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="text" name="phoneno" id="phoneno" value="<?php echo $phoneno; ?>"
                                     autocomplete="off"  maxlength="10" class="input-large" ></td>
                                   </tr> 
                                  ...
                                  <tr>
                                    ...
                                    <td width="37%"><input type="text" name="mobileno2" id="mobileno2" value="<?php echo $mobileno2; ?>" autocomplete="off" maxlength="10" class="input-large" ></td>
                                  </tr>
                                  
                                   <tr>
                                    <td><strong>Email Id</strong></td>
                                    <td width="25%">
                                    <input type="text" name="email_id" value="<?php echo $email_id; ?>" id="email_id" class="input-large" >
                                    </td>
                          ...
                          class="input-large" ></td>
                                   <td width="11%"> <strong>Pan Card:</strong></td>
                                    <td><input type="text" name="pan_card" id="pan_card" maxlength="20" value="<?php echo $pan_card; ?>"
                                    ...
                                    <tr>
                                     ...
                                     <td><input type="text" name="gst_no" id="gst_no" maxlength="20" value="<?php echo $gst_no; ?>"
                                     autocomplete="off" class="input-large" ></td>
									 
									 <td width="11%"> <strong>SAAC Code:</strong></td>
                                     <td><input type="text" name="saaccode" id="saaccode" maxlength="20" value="<?php echo $saaccode; ?>" autocomplete="off" class="input-large" ></td>
                          ...
                          class="input-large" ></td>
                                    ...
                                    <td width="25%"><input type="text" name="venderCode" maxlength="20" value="<?php echo $venderCode; ?>" id="chl_prefix" 
                          class="input-large" ></td> 
						  ...
						  <td width="25%"><input type="text" name="ifsc_code" maxlength="20" value="<?php echo $ifsc_code; ?>" id="chl_prefix" 
                          class="input-large" ></td> 
                     
                          </tr>
						  
						  <tr>
						  <td width="11%"> <strong>Account Holder</strong></td>

<td width="25%"><input type="text" name="account_holder" value="<?php echo $account_holder; ?>" id="chl_prefix" 
class="input-large" ></td> 
									...
									<td width="11%"> <strong>Logo</strong></td>
                                           <td>
                                             ...
                                             <input type="file" name="c_logo" id="c_logo"   
                                               ...
                                               <span><img src="logo/<?php echo $c_logo ?>" width="100px;" alt="" /></span>
										   </td>
									</tr>
                                 <tr>
