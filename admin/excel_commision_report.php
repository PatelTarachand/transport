...
$tblname = 'bilty_entry';
$tblpkey = 'bilty_id';
$pagename  ='excel_commision_report.php';
...
$sel = "select  *  from bidding_entry where $crit and payment_date between '$fromdate' and '$todate'  $cond && commission !=0 order by bid_id desc";
