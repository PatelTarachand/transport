...
$tblpkey = 'payid';
$pagename  ='consignor_payment_report.php';
                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							...
							<div class="box-title">
							<h3><i class="icon-table"></i>Consignor Reports Report Details</h3>

								<a class="btn btn-primary btn-lg" href="excel_consignor_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" target="_blank" 
