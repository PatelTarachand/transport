...
$keyvalue="";
	...
	$sql = mysqli_query($connection,"select * from return_bilty_payment_voucher where payid='$payid'");
	...
	$ac_number = $cmn->getvalfield($connection,"m_truckowner","ac_number","ownerid='$ownerid'");
		...
		$totalpayamount = $cmn->getvalfield($connection,"return_bilty_payment_voucher","sum(payamount)","ownerid='$ownerid' && voucher_id='$voucher_id' ");
