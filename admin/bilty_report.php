...
<?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp;<?php echo $modulename; ?> Report </legend>
                        ...
                        <option value=""> - All - </option>
                        <?php 
                        $sql_fdest = mysqli_query($connection,"select * from m_truck order by truckno");
                        while($row_fdest = mysqli_fetch_array($sql_fdest))
                        {
                        ?>
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
                            	...
                            	<a class="btn btn-primary btn-lg" href="excel_bilty_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&itemid=<?php echo $itemid; ?>&truckid=<?php echo $truckid; ?>" target="_blank" 
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									else
									{
									 ...
									 $sel = "select * from bidding_entry $cond && sessionid='$sessionid' && is_bilty=1 $crit and consignorid !=4 and compid='$compid' order by bid_id desc";
