                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
							<h3><i class="icon-table"></i>Transporting Commission Report Details</h3>
								<a class="btn btn-primary btn-lg" href="excel_transport_commision_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&consigneeid=<?php echo $consigneeid; ?>&truckid=<?php echo $truckid; ?>" target="_blank" 
