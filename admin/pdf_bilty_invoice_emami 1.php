...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{		
		global $title1,$di_no,$pan_card,$tokendate,$gr_no,$ewayno,$companyname,$companyaddrs,$companymob1,$companymob2,$company_gst,$lr_no,$phoneno,$c_logo;
...
//$this->Image('bpslogo.png',80,3,35,16);//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
	...
	$this->SetX(139);
	$this->Cell(138,5,$companyname,0,0,'L',0);
...
$pdf->AddPage('L','A5');
 ...
 //   $pdf->Cell(66,5,"Excise Invoice No : $invoiceno",1,1,'L',0);
	...
	$pdf->Cell(30,6,'Item',1,0,'L',0);
	$pdf->Cell(24,6,'Weight(bags)','1',0,'C',0); 
	$pdf->Cell(20,6,'Weight(MT)',1,0,'L',0);
	$pdf->Cell(33,6,'OWN Rate',1,0,'C',0);
	$pdf->Cell(25,6,'Freight Amt',1,1,'C',0);
	$pdf->SetFont('Arial','',6);
	
	$pdf->SetX(5);
	$pdf->SetFont('arial','',11);	
	$pdf->Cell(30,8,$itemname,1,0,'L',0);
	$pdf->Cell(24,8,$noofqty,1,0,'C',0);
	$pdf->Cell(20,8,$totalweight.' MT',1,0,'C',0);
	$pdf->Cell(33,8,$own_rate." / MT",1,0,'R',0);
	...
	$pdf->Cell(38,6," Cash Advance ",1,0,'L',0);
	$pdf->Cell(15,6,'',1,1,'R',0);
	$pdf->SetY(78);
	$pdf->SetX(112);
	$pdf->Cell(25,6,number_format($adv_cash,2),1,1,'R',0);
