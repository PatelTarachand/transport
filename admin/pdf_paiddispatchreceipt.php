...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(180,4,'Advance Voucher','0',1,'C',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(20,4,'Invoice No','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(25,4,': '.$invoiceno,'0',1,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(65,4,': '.$ownername,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
//$totalamt = $wt_mt*$newrate;
		...
		$pdf->Cell(35,5,$rate_mt,1,0,'L',0);
	
		$pdf->Cell(42,5,number_format($netamount,2),1,1,'L',0);
...
$pdf->Cell(40,6,ucwords(convert_number_to_words($balamt))." Rupees Only",0,1,'L',0);
$pdf->ln(10);
