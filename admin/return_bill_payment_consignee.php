...
$tblname = 'return_consignee_payment';
$tblpkey = 'payid';
$pagename  ='return_bill_payment_consignee.php';
...
if(isset($_GET['consigneeid']) && isset($_GET['billid']))
{
	 ...
	 $payamount = $cmn->getvalfield($connection,"return_consignee_payment","sum(payamount)","consigneeid='$_GET[consigneeid]' && billid='$_GET[billid]' ");
	 $totaltdsamt = $cmn->getvalfield($connection,"return_consignee_payment","sum(tdsamt)","consigneeid='$_GET[consigneeid]' && billid='$_GET[billid]' ");
	  $deduct_amount = $cmn->getvalfield($connection,"return_consignee_payment","sum(deduct_amount)","consigneeid='$_GET[consigneeid]' && billid='$_GET[billid]' ");
 ...
 <?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
		<div id="main">
			  <div class="container-fluid">
                   ...
                   <form method="post" action="">
                    <input type="hidden" name="pagename" id="pagename" value="<?php echo $pagename;?>">                    <?php //echo "select bid_id,di_no from returnbidding_entry $crit  && recweight !='0' && consigneeid =4"; ?>
    	...
    	<legend class="legend_blue"><i class="icon-edit"></i>&nbsp; Paid to Conginee</legend>   
			...
			$sql_fdest = mysqli_query($connection,"select * from returnbill where consigneeid='$_GET[consigneeid]' and sessionid= $sessionid");
			while($row_fdest = mysqli_fetch_array($sql_fdest))
			{
	 ...
	 $tdsamt1 = $cmn->getvalfield($connection,"return_consignee_payment","sum(tdsamt)","consigneeid='$row_fdest[consigneeid]' && billid='$row_fdest[billid]' ");
		
				 $bill_amount1= $cmn->get_consigneetotal_billing_amt($connection,"$row_fdest[billid]");
	 $payamount1 = $cmn->getvalfield($connection,"return_consignee_payment","sum(payamount)","consigneeid='$row_fdest[consigneeid]' && billid='$row_fdest[billid]' ");
	 $deduct_amount1 = $cmn->getvalfield($connection,"return_consignee_payment","sum(deduct_amount)","consigneeid='$row_fdest[consigneeid]' && billid='$row_fdest[billid]' ");
						...
						<div class="box-title">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$sel = "SELECT * FROM `return_consignee_payment` WHERE compid='$compid' && consigneeid='$_GET[consigneeid]' and sessionid= $sessionid order by payid desc";
