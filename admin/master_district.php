...
$tblname = "m_district";
$tblpkey = "districtid";
$pagename = "master_district.php";
$modulename = "District Registration";
...
if(isset($_GET['edit']))
{
	$districtid=$_GET['edit'];
	$sql_edit="select * from m_district where districtid='$districtid'";
...
if(isset($_POST['submit']))
{
	...
	if($districtid==0)
	{
		...
		$sql_chk = "select * from m_district where distname='$distname'";
		$res_chk = mysqli_query($connection,$sql_chk);
		$cnt = mysqli_num_rows($res_chk);
		
		if($cnt == 0)
		{
			$sql_insert="insert into m_district set  distname = '$distname', createdate=now(),sessionid = '$_SESSION[sessionid]'";
			mysqli_query($connection,$sql_insert);
			$keyvalue = mysqli_insert_id($connection);
			$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'insert');
			echo "<script>location='master_district.php?action=1'</script>";
		}
		else
	...
	{
		$sql_update = "update  m_district set distname = '$distname', lastupdated=now() where districtid='$districtid'";
		mysqli_query($connection,$sql_update);
		$keyvalue = $districtid;
		$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'updated');
		echo "<script>location='master_district.php?action=2'</script>";
	}
}
					...
					<div class="span6">
						<div class="box">
							...
							<div class="box-content">
                                 <form  method="post" action="" class='form-horizontal' onSubmit="return checkinputmaster('distname')">
                                <div class="control-group">
                                
                                
                                  	<label for="name" class="control-label">District Name:<span class="red">*</span></label>
                                  	<input type="text" name="distname" id="distname" value="<?php echo $distname ; ?>"  tabindex="8">
                                &nbsp;&nbsp;&nbsp;
                                    <input type="submit" name="submit" id="submit" value="Save" class="btn btn-success"
                                     onClick="return checkinputmaster('consigneename,placeid')" tabindex="10">
								...
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									?>
										<tr>
                                           ...
                                           <td class='hidden-480'>
                                           <a href= "?edit=<?php echo ucfirst($row['districtid']);?>"><img src="../img/b_edit.png" title="Edit"></a>
                                           &nbsp;&nbsp;&nbsp;
                                           <a onClick="funDel('<?php echo $row['districtid']; ?>')" ><img src="../img/del.png" title="Delete"></a>
                                           </td>
										</tr>
                                        <?php
										$slno++;
