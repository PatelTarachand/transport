...
if(isset($_POST['save'])) {
   ...
   echo "update payment set iscomp=1 where type='sale' && iscomp=0";
	mysqli_query($connection,"update payment set iscomp=1 where type='sale' && iscomp=0");	
	echo "<script>window.location='sale_payment.php?action=1'</script>";
               ...
               <div class="span12">
                  <div class="box">
                     <div class="box-title">
                        ...
                        <a href="sale_payment_report.php" class="btn btn-success" style="float:right;">View Detail</a>
