...
if(isset($_POST['submit']))
{
	...
	if($keyvalue==0)
	{
		mysqli_query($connection,"insert into m_bonus set avg_from='$avg_from',avg_to='$avg_to',bonus_amt='$bonus_amt',ipaddress='$ipaddress',createdate='$createdate',
					createdby='$userid'");	
		$action = 1;
	}
	else
	{
		mysqli_query($connection,"update m_bonus set avg_from='$avg_from',avg_to='$avg_to',bonus_amt='$bonus_amt',ipaddress='$ipaddress',lastupdate='$createdate',
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									<thead>
										<tr>
                                            <th width="10%">Sno</th>  
                                            <th width="40%">Average From</th>
                                            <th width="40%">Average To</th>
                                            <th width="40%">Bonus Amount</th>
