...
<body onLoad="hideval();">
	...
	<div class="container-fluid" id="content">
		...
		<div id="main">
			...
			<a href="builty_receive.php" class="btn btn-primary">Show List</a>
							...
							<div class="box-content nopadding" style="overflow:scroll">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered" width="100%">
									...
									<tbody>
										<?php
										$sn = 1;
									//echo "select * from bidding_entry where 1=1 && is_bilty=1 $cond  && compid='$compid' && sessionid=$sessionid and recdate='0000-00-00' order by bid_id";
										$sql = mysqli_query($connection, "select * from bidding_entry where 1=1 && is_bilty=1 $cond  && compid='$compid' && sessionid=$sessionid and recdate='0000-00-00' order by bid_id");
	...
	<script>
		...
		function getsave(bid_id) {
			...
			$.ajax({
				...
				data: 'bid_id=' + bid_id + '&recweight=' + recweight + '&recdate=' + recdate + '&sortagr=' + sortagr + '&recbag=' + recbag + '&shortagetype=' + shortagetype,
				dataType: 'html',
				success: function(data) {
					//alert(data);
					// alert('Data Deleted Successfully');
