...
$tblpkey = 'bid_id';
$pagename  ='diesel_advance_report.php';
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp;<?php echo $modulename; ?> Report </legend>
                            <table width="1037">
                                    <tr>
                                            ...
                                            <th width="15%" style="text-align:left;">Petrol Pump:</th>
                                    ...
                                    <tr>
                                            ...
                                            <td><select id="supplier_id" name="supplier_id" class="select2-me input-large" style="width:220px;">
                        <option value=""> - All - </option>
                        <?php 
                        $sql_fdest = mysqli_query($connection,"select * from inv_m_supplier");
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
                            	...
                            	<a class="btn btn-primary btn-lg" href="excel_diesel_advance_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&supplier_id=<?php echo $supplier_id; ?>" target="_blank" 
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									$totaldieseladv=0;
									 $sel = "select * from bidding_entry $cond && sessionid='$sessionid' && is_bilty=1 && isdispatch=1 && adv_diesel !=0 and consignorid !=4 $crit order by bid_id desc";
