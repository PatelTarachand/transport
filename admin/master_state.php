...
{
	$stateid=$_GET['edit'];
	$sql_edit="select * from m_state where stateid='$stateid'";
...
if(isset($_POST['submit']))
{
	...
	if($stateid==0)
	{
		...
		$sql_chk = "select * from m_state where statename='$statename'";
		$res_chk = mysqli_query($connection,$sql_chk);
		$cnt = mysqli_num_rows($res_chk);
		
		if($cnt == 0)
		{
			$sql_insert="insert into m_state set  statename = '$statename',statecode = '$statecode',createdate=now(),sessionid = '$_SESSION[sessionid]'";
			mysqli_query($connection,$sql_insert);
			$keyvalue = mysqli_insert_id($connection);
			
			$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'insert');
			echo "<script>location='master_state.php?action=1'</script>";
		}
		else
	...
	{
		$sql_update = "update m_state set  statename = '$statename',statecode = '$statecode',createdate=now(),sessionid = '$_SESSION[sessionid]' where stateid='$stateid'";
		mysqli_query($connection,$sql_update);
		$keyvalue = $stateid;
		$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'updated');
		echo "<script>location='master_state.php?action=2'</script>";
	}
}
					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
                                 <form  method="post" action="" class='form-horizontal' onSubmit="return checkinputmaster('statename')">
                                ...
                                <table>
                                    ...
                                    <tr>
                                    	<td>
                                            <label for="name" class="control-label">State Name:<span class="red">*</span></label>
                                            <input type="text" name="statename" id="statename" value="<?php echo $statename ; ?>"  tabindex="3" autocomplete="off" >
                                        </td>
                                        <td>&nbsp;&nbsp;&nbsp;</td>
                                        <td>
                                            <label for="name" class="control-label">State Code:<span class="red">*</span></label>
                                           <input type="text" name="statecode" id="statecode" value="<?php echo $statecode ; ?>"  tabindex="3"  autocomplete="off">
                                        </td>
                                    </tr>
 <tr><td>&nbsp;&nbsp;&nbsp;</td></tr>
                                   ...
                                   <td colspan="4" style="line-height:5">
                                    <input type="submit" name="submit" id="submit" value="Save" class="btn btn-success"
                                     onClick="return checkinputmaster('statename,statecode')" tabindex="10" style="margin-left:308px">
								...
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
									...
									?>
										<tr>
                                           ...
                                           <td class='hidden-480'>
                                           <a href= "?edit=<?php echo ucfirst($row['stateid']);?>"><img src="../img/b_edit.png" title="Edit"></a>
                                           &nbsp;&nbsp;&nbsp;
                                           <a onClick="funDel('<?php echo $row['stateid']; ?>')" ><img src="../img/del.png" title="Delete"></a>
                                           </td>
										</tr>
                                        <?php
										$slno++;
