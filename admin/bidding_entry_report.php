...
<?php include("../include/top_menu.php"); ?> <!--- top Menu----->
	<div class="container-fluid nav-hidden" id="content">
    	...
    	<legend class="legend_blue"> <i class="icon-edit"></i>&nbsp;Bidding Report </legend>
                            <table width="1037">
                                    <tr>
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
                            	...
                            	<a class="btn btn-primary btn-lg" href="excel_bidding.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" target="_blank" 
