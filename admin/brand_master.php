...
if(isset($_GET['brand_id']))
{
	...
	$sql_edit="select * from brand_master where brand_id='$brand_id'";
...
if(isset($_POST['submit']))
{
	...
	if($brand_id==0)
	{
		...
		$sql_chk = "select * from brand_master where brand_name='$brand_name'";
		$res_chk = mysqli_query($connection,$sql_chk);
		$cnt = mysqli_num_rows($res_chk);
		
		if($cnt == 0)
		{
			 $sql_insert="insert into brand_master set brand_name = '$brand_name', createdate=now(),sessionid = '$_SESSION[sessionid]'"; 
			mysqli_query($connection,$sql_insert);
			$keyvalue = mysqli_insert_id($connection);
			$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'insert');
			echo "<script>location='brand_master.php?action=1'</script>";
		}
		else
	...
	{
		$sql_update = "update  brand_master set brand_name = '$brand_name', lastupdated=now() where brand_id='$brand_id'";
		mysqli_query($connection,$sql_update);
		//$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey,'updated');
		echo "<script>location='brand_master.php?action=2'</script>";
	}
}
?>
<!doctype html>
					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
                                 <form  method="post" action="" class='form-horizontal' onSubmit="return checkinputmaster('brand_name')">
                                ...
                                <tr>
                                    <td ><strong>Brand Name</strong> <strong>:</strong><span class="red">*</span></td>
                                    <td ><input type="text" name="brand_name" id="brand_name" value="<?php echo $brand_name; ?>"
                                     autocomplete="off"  maxlength="120" tabindex="1" placeholder='Enter Brand Name'  class="input-large" ></td>
                                 ...
                                 <td colspan="4" style="line-height:5">
                                    ...
                                    <input type="submit" name="submit" id="submit" value="Save" class="btn btn-success"
                                     onClick="return checkinputmaster('brand_name')" tabindex="10">
								...
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
											...
											$sql_get = mysqli_query($connection,"select * from brand_master order by brand_id desc");
										...
										<tr>
                                            <td><?php echo $slno; ?></td>
                                            <td><?php echo ucfirst($row_get['brand_name']);?></td>
                                           	<td class='hidden-480'>
                                           <a href= 'brand_master.php?brand_id=<?php echo  $row_get['brand_id'] ; ?>'><img src="../img/b_edit.png" title="Edit"></a>
                                           &nbsp;&nbsp;&nbsp;
