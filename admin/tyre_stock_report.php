...
$modulename = "Month Wise Tyre Stock Report";
...
<form id="myform"  method="get" action="" class='form-horizontal' onSubmit="return checkinputmaster('fromdate,todate')" > 
					...
					<div class="span12">
						<div class="box">
							...
							<table class="table table-condensed table-bordered">
							  ...
							  <tr>
							    <td width="14%" ><strong>From Date <span style="color:#F00;">*</span> :</strong><span style="color:#F00;font-size:10px;"> (dd-mm-yyyy)</span></td>
							    <td width="14%" ><strong>To Date <span style="color:#F00;">*</span> :</strong><span style="color:#F00;font-size:10px;"> (dd-mm-yyyy)</span></td>
							  ...
							  <tr>
                                ...
                                <a href="<?php echo $pagename; ?>" class="btn btn-inverse">Cancel</a>
		...
		<div id="main">
			<div class="container-fluid">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-table"></i><?php echo $modulename; ?> Details
    
                                </h3>
                                  <div style="float:right;">
      <a class="btn btn-primary" href="excel_tyre_stock_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&tnumber=<?php echo $tnumber; ?>&supplier_id=<?php echo $supplier_id; ?>" target="_blank">Excel</a> 
      </div>   
							</div>
