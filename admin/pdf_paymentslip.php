...
$bilty_id = trim(addslashes($_GET['bilty_id']));
	...
	$sql = mysqli_query($connection,"select wt_mt,rate_mt,newrate,adv_date,adv_cash,adv_diesel,adv_cheque,cheque_no,consignorid,consigneeid,
					   placeid,drivername,driver_mobile,destinationid,itemid,bankid,truckid,truckowner,truckownermobile,advchequedate,paid_no from bilty_entry where bilty_id='$bilty_id'");
	...
	$billtyno = $cmn->getvalfield($connection,"bilty_entry","billtyno","bilty_id='$bilty_id'");	
	...
	$balamt = $adv_cash + $adv_diesel + $adv_cheque;
...
$this->Cell(50,5,'Director',0,0,'L',0);

$this->SetFont('Arial','b',9);
$this->SetTextColor(0,0,0);
$this->Cell(50,5,'Accountant',0,0,'L',0);

$this->SetFont('Arial','b',9);
$this->SetTextColor(0,0,0);
$this->Cell(50,5,'Cashier',0,0,'L',0);


$this->SetFont('Arial','b',9);
$this->SetTextColor(0,0,0);
$this->Cell(50,5,'Receiver',0,0,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(170,4,'Contact No - 9753636858, 6261755311','0',1,'C',0);
$pdf->Ln(3);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(22,4,'GR No','0',0,'R',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(50,4,': '.$paid_no,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,': '.$adv_date,'0',0,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(25,4,': '.$billtyno,'0',1,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,': '.$drivername,'0',0,'L',0);
//$pdf->Ln(2);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,': '.$driver_mobile,'0',0,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(35,4,': '.$truckowner,'0',1,'L',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(23,4,'DI No','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(39,4,': '.$truckno,'0',0,'L',0);


$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(20,4,'Destination','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,4,': '.$truckownermobile,'0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);

$pdf->Cell(25,4,'Paid Amount','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(50,4,': '.number_format($balamt,2),'0',1,'L',0);
...
$totalamt = $wt_mt*$newrate;
		...
		$pdf->Cell(80,5,'Description',1,0,'L',0);
		$pdf->Cell(40,5,'Weight(MT)',1,0,'L',0);
		$pdf->Cell(35,5,'Rate',1,0,'L',0);
		$pdf->Cell(42,5,'Total',1,1,'L',0);  
		 
		
				
		$pdf->SetFont('Arial','B',8);
		$pdf->Cell(80,5,$itemname,1,0,'L',0);
		$pdf->Cell(40,5,$wt_mt,1,0,'L',0);
		$pdf->Cell(35,5,$newrate,1,0,'L',0);
		$pdf->Cell(42,5,$totalamt,1,1,'L',0);
...
$pdf->SetX(10);
$pdf->Cell(150,6,'Payment Commission' ,1,0,'R',0);
$pdf->Cell(40,6,number_format($adv_diesel,2),1,1,'R',0);


$pdf->SetX(10);
$pdf->Cell(150,6,'Bilty Commission' ,1,0,'R',0);
$pdf->Cell(40,6,number_format($adv_diesel,2),1,1,'R',0);


$pdf->SetX(10);
$pdf->Cell(150,24,'Bank Account ',1,0,'L',0);
$pdf->Cell(40,24," ",1,1,'R',0);
...
$pdf->Cell(40,6,number_format($balamt,2),1,1,'L',0);
