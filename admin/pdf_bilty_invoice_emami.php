...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{		
		global $title1,$di_no,$pan_card,$tokendate,$gr_no,$ewayno,$companyname,$companyaddrs,$companymob1,$companymob2,$company_gst,$lr_no,$phoneno,$c_logo,$logo,$email_id;
...
// 	    $pdf->MultiCell(60,4,"$destination",0,'L');
 ...
 //   $pdf->Cell(66,5,"Excise Invoice No : $invoiceno",1,1,'L',0);
	...
	$pdf->Cell(14,6,'Item',1,0,'L',0);
			$pdf->Cell(15,6,'Brand',1,0,'L',0);
		$pdf->Cell(28,6,'Meth.of Packing',1,0,'L',0);

	$pdf->Cell(21,6,'Weight(bags)','1',0,'C',0); 
	$pdf->Cell(18,6,'Weight(MT)',1,0,'L',0);
	$pdf->Cell(17,6,'OWN Rate',1,0,'C',0);
	$pdf->Cell(19,6,'Freight Amt',1,1,'C',0);
	$pdf->SetFont('Arial','',6);
	
	$pdf->SetX(5);
	$pdf->SetFont('arial','b',6);	
	$pdf->Cell(14,8,$itemname,1,0,'L',0);
	$pdf->Cell(15,8,$brand_name,1,0,'L',0);
	$pdf->Cell(28,8,$m_packing."  $packingqty",1,0,'L',0);
	$pdf->Cell(21,8,$noofqty,1,0,'C',0);
	$pdf->Cell(18,8,$totalweight.' MT',1,0,'C',0);
	$pdf->Cell(17,8,$own_rate." / MT",1,0,'R',0);
	$pdf->Cell(19,8,number_format($total_freight,2),1,1,'R',0);
