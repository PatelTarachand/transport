...
$tblname = "inv_m_supplier";
$tblpkey = "supplier_id";
$pagename = "master_supplier.php";
$modulename = "Petrol Pump";
...
if(isset($_GET['edit']))
{
	...
	$sql_edit="select * from inv_m_supplier where supplier_id='$supplier_id'";
	...
	if($res_edit)
	{
		while($row=mysqli_fetch_array($res_edit))
		{
			...
			$diesel_open_bal = $row['diesel_open_bal'];
			$diesel_open_bal_date = $cmn->dateformatindia($row['diesel_open_bal_date']);
			$petrol_open_bal = $row['petrol_open_bal'];
			$petrol_open_bal_date = $cmn->dateformatindia($row['petrol_open_bal_date']);
		}//end while
	}//end if
}//end if
else
{
	...
	$diesel_open_bal ='';
	$diesel_open_bal_date = date('d-m-Y');
	$petrol_open_bal = '';
	$petrol_open_bal_date =date('d-m-Y');
	$incdate = date('d-m-Y');
}
...
if(isset($_POST['submit']))
{
	...
	$diesel_open_bal = $_POST['diesel_open_bal'];
	$diesel_open_bal_date = $cmn->dateformatusa($_POST['diesel_open_bal_date']);
	$petrol_open_bal = $_POST['petrol_open_bal'];
	$petrol_open_bal_date = $cmn->dateformatusa($_POST['petrol_open_bal_date']);
	$type = $_POST['type'];
	
	if($supplier_id==0)
	{
		//check doctor existance
		$sql_chk = "select * from inv_m_supplier where supplier_name='$supplier_name'";
		$res_chk = mysqli_query($connection,$sql_chk);
		$cnt = mysqli_num_rows($res_chk);
		if($cnt == 0)
		{			
					
			$sql_insert="insert into inv_m_supplier set supplier_name = '$supplier_name',address='$address', district='$district', 
			state='$state', mobile1 = '$mobile1',mobile2='$mobile2', phoneno1='$phoneno1',phoneno2='$phoneno2',email = '$email',
			faxno='$faxno', service_tax_no='$service_tax_no',gstno='$gstno', cstno = '$cstno',panno='$panno', rslno='$rslno', 
			taxdeduction_acc_no='$taxdeduction_acc_no',contact_persion='$contact_persion',designation = '$designation',type='$type',
			contact_persion_mobile='$contact_persion_mobile',diesel_open_bal='$diesel_open_bal',diesel_open_bal_date='$diesel_open_bal_date',
			petrol_open_bal='$petrol_open_bal',petrol_open_bal_date='$petrol_open_bal_date',contact_persion_email='$contact_persion_email',
			createdate=now(),lastupdated=now(), sessionid = '$_SESSION[sessionid]'";
			mysqli_query($connection,$sql_insert);
			$keyvalue = mysqli_insert_id($connection);
			$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'insert');
			echo "<script>location='master_supplier.php?action=1'</script>";
		}
		else
	...
	{
		$sql_update = "update  inv_m_supplier set supplier_name = '$supplier_name',address='$address',  district='$district', state='$state',mobile1 = '$mobile1',mobile2='$mobile2',  phoneno1='$phoneno1', phoneno2='$phoneno2',email = '$email',faxno='$faxno',  service_tax_no='$service_tax_no', gstno='$gstno',cstno = '$cstno',panno='$panno',  rslno='$rslno', taxdeduction_acc_no='$taxdeduction_acc_no', contact_persion='$contact_persion', designation='$designation',contact_persion_mobile='$contact_persion_mobile',type='$type',
		diesel_open_bal='$diesel_open_bal',diesel_open_bal_date='$diesel_open_bal_date',petrol_open_bal='$petrol_open_bal',
		petrol_open_bal_date='$petrol_open_bal_date',contact_persion_email='$contact_persion_email', lastupdated=now() where supplier_id='$supplier_id'";
		mysqli_query($connection,$sql_update);
		$keyvalue = $supplier_id;
		$cmn->InsertLog($connection,$pagename, $modulename, $tblname, $tblpkey, $keyvalue,'updated');
		echo "<script>location='master_supplier.php?action=2'</script>";
	}
}
...
<table width="100%" border="0" class="table table-bordered table-condensed" >
  ...
  <tr><td align="center"><input type="submit" value="Save" class="btn-small btn-success" onClick="ajax_save_placename();"/></td></tr>
	...
	<div class="container-fluid" id="content">
					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
                                ...
                                <table style="width:60%;" border="0" class="gap">
    	<tr>
            <td width="15%">Petrol Pump Name <span class="err">*</span></td>
            <td width="23%"><input type="text" name="supplier_name" id="supplier_name" class="frmsave formbox" data-required="true" value="<?php echo $supplier_name; ?>" autocomplete="off">
            </td>
            <td width="14%">Address </td>
            <td width="23%"><input type="text" name="address" id="address" class="frmsave formbox" value="<?php echo $address; ?>" autocomplete="off">
            </td>
        </tr>
        <tr>
            <td width="15%">District</td>
            <td width="23%"><input type="text" id="district" name="district" class="frmsave formbox" value="<?php echo $district; ?>" autocomplete="off">
            </td>
            <td width="14%">State</td>
            <td width="23%"><input type="text" id="state" name="state" class="frmsave formbox" value="<?php echo $state; ?>" autocomplete="off">
            </td>
        </tr>
        <tr>
            <td width="15%">Mobile No-1 </td>
            <td width="23%"><input type="text" id="mobile1" name="mobile1" class="frmsave formbox" maxlength="13" value="<?php echo $mobile1; ?>" autocomplete="off">
            </td>
            <td width="14%">Mobile No-2</td>
            <td width="23%"><input type="text" id="mobile2" name="mobile2" class="frmsave formbox" maxlength="13" value="<?php echo $mobile2; ?>" autocomplete="off">
            </td>
        </tr>
      
        <tr>
            <td width="15%">Email</td>
            <td width="23%"><input type="text" id="email" name="email" class="frmsave formbox" value="<?php echo $email; ?>" autocomplete="off">
            </td>
       
            <td width="14%">GST No</td>
            <td width="23%"><input type="text" id="gstno" name="gstno" class="frmsave formbox" value="<?php echo $gstno; ?>" maxlength="20" autocomplete="off">
            </td>
        </tr>
        <tr>
            
            <td width="14%">PAN No</td>
            <td width="48%"><input type="text" id="panno" name="panno" class="frmsave formbox" maxlength="16" value="<?php echo $panno; ?>" maxlength="20" autocomplete="off">
            </td>
        <td width="15%">RSL No</td>
            <td width="23%"><input type="text" id="rslno" name="rslno" class="frmsave formbox" value="<?php echo $rslno; ?>" maxlength="20" autocomplete="off">
            </td>
          
        </tr>
        <tr>
            <td width="15%">Contact Persion</td>
            <td width="23%"><input type="text" id="contact_persion" name="contact_persion" class="frmsave formbox" value="<?php echo $contact_persion; ?>" autocomplete="off">
            </td>
        
            <td width="15%">Petrol Opening Bal.</td>
            <td width="23%"><input type="text" id="petrol_open_bal" name="petrol_open_bal" class="frmsave formbox" value="<?php echo $petrol_open_bal; ?>"  autocomplete="off">
            </td>
        ...
        <tr>
            <td width="14%">Petrol Open. Bal. Date</td>
            <td width="23%"><input type="text" id="petrol_open_bal_date" name="petrol_open_bal_date" class="frmsave formbox" value="<?php echo $petrol_open_bal_date; ?>">
            </td>
      
            <td width="15%">Type</td>
            <td width="23%">
            <select name="type" id="type" onChange="getppsupplierid();" >
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered">
                                    ...
                                    <?php
									$slno=1;
									$sel = "select * from inv_m_supplier";
...
jQuery(function($){
   $("#petrol_open_bal_date").mask("99-99-9999",{placeholder:"dd-mm-yyyy"});
