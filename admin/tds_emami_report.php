...
$tblpkey = 'bid_id';
$pagename  ='tds_emami_report.php';
$modulename = "TDS Reports";
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								...
								<h3><i class="icon-table"></i>TDS Reports Report Details</h3>
							
								<a class="btn btn-primary btn-lg" href="excel_tds_emami_report.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" target="_blank" 
