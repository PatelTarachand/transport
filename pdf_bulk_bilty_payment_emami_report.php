...
$c_logo = $cmn->getvalfield($connection,"m_company","c_logo","compid='$_SESSION[compid]'");
  ...
  $receive_date = dateformatindia($cmn->getvalfield($connection,"bilty_payment_voucher","receive_date","voucher_id='$bulk_voucher_id'"));
  ...
  $sql = mysqli_query($connection,"select * from m_truckowner where ownerid='$ownerid'");
    ...
    $voucher_amount= showBiltyVoucher($connection,$compid,$bulk_voucher_id);	
    $payamount = $cmn->getvalfield($connection,"bilty_payment_voucher","sum(payamount)","ownerid='$ownerid' && voucher_id='$bulk_voucher_id' ");

    $bal_amt=$voucher_amount-$payamount;
...
$pdf->SetY(10);
 ...
 $pdf->SetX(20);
                  ...
                  $OWNres = mysqli_query($connection,$OWN);
                               ...
                               $invoicquery = "SELECT * from  bidding_entry Where  voucher_id='$bulk_voucher_id' && compid='$compid' ";      
 ...
 $paidto=$incrow['paidto']; 
      $remark=$incrow['remark']; 
                                        ...
                                        $pdf->Ln(10);
                                            ...
                                            $pdf->SetFont('Arial','B',8);
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(21,8,'Cash Adv(Self)',1,0,'R');
                                                     
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(24,8,'Cash Adv(Consi)',1,0,'R');
                                                ...
                                                $total_tds=0;
                                                         $sn=1;
                                                           $sel = "SELECT * from  bidding_entry Where  voucher_id='$bulk_voucher_id' && compid='$compid' "; 
                      ...
                      $total_paid= $netamount-$commission-$adv_diesel-$tot_adv-$tds_amount;
                      $final_rate=$rate_mt-$trip_commission;
                                            ...
                                            $pdf->SetFont('Arial','',8);
                                                    ...
                                                    //  $pdf->Cell(13,8,$trip_commission,1,0,'R');
                                                     ...
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(15,8,round($deduct),1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','',8);
                                                     ...
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(21,8,round($adv_cash),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(24,8,round($adv_consignor),1,0,'R');
                                                ...
                                                $total_tds+=$tds_amt;
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,12,$total_deduct,1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(21,12,$total_adv,1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(24,12,round($toal_advconsi),1,0,'R');
                                                     ...
                                                     $pdf->Cell(20,12,number_format(round($great_total),2),1,0,'R');
                                                      ...
                                                      $pdf->SetFont('Arial','B',10);
                                                     $pdf->Cell(214,12,'Grant Total Amount',1,0,'C');

                                                     
                                                     $pdf->Cell(65,12,number_format(round($great_total),2),1,0,'R');
