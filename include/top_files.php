    ...
    <meta names="apple-mobile-web-app-status-bar-style" content="black-translucent" />	
	<title> <?php echo  $cmn->getvalfield($connection,"m_company","cname","compid='$_SESSION[compid]'"); ?></title>
	<!-- Bootstrap -->
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="menu/css/plugins/jquery-ui/jquery-ui.min.css">
...
$(document).ready(function(){
 $("#list").hide();
	...
	if(n=="Add New")
	{
		...
		//alert(''+n);
		$("#addnew").val(''+n);
		$("#myform input:text, #myform textarea").first().focus();
	}
	else
	{
		n="Add New";
...
.trinity_feild{ padding: 5px 0px 20px 10px}
